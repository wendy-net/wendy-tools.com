...
class Assets
{
    ...
    public function enqueue_frontend_scripts()
    {
        ...
        // Sidebar assets
        wp_register_style( 'kenta-blocks-frontend-sidebar-styles', false, $sidebar_st );
        ...
        wp_register_script( 'kenta-blocks-frontend-sidebar-script', false, $sidebar_sc );
        ...
        // Dynamic inline mode
        wp_register_style( 'kenta-blocks-frontend-styles', false, $post_st );
        ...
        wp_register_script( 'kenta-blocks-frontend-inline-script', false, $post_sc );
