...
/**
 * Title: front-page
 * Slug: eclipse-creative-portfolio/front-page
 * Categories: hidden
 * Inserter: no
 */
?>
<!-- wp:group {"className":"smot","layout":{"type":"default"},"metadata":{"name":"Smoother Scrool"}} -->
<div class="wp-block-group smot"><!-- wp:group {"tagName":"main","align":"full","className":"smother_scroll","layout":{"type":"default"},"metadata":{"name":"Main Content"}} -->
<main class="wp-block-group alignfull smother_scroll"><!-- wp:template-part {"slug":"header","area":"header"} /-->

<!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|80","left":"var:preset|spacing|80","top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}}},"backgroundColor":"second","className":"hero_bg","layout":{"type":"default"},"metadata":{"name":"Welcome Hero"}} -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|30","bottom":"var:preset|spacing|30"}}},"backgroundColor":"first","layout":{"type":"constrained"},"metadata":{"name":"Floating Icons"}} -->
<div class="wp-block-group has-first-background-color has-background" style="padding-top:var(--wp--preset--spacing--30);padding-bottom:var(--wp--preset--spacing--30)"><!-- wp:social-links {"iconColor":"white","iconColorValue":"#ffffff","size":"has-normal-icon-size","style":{"spacing":{"blockGap":{"top":"var:preset|spacing|40"}}},"className":"is-style-logos-only","layout":{"type":"flex","orientation":"horizontal","justifyContent":"space-between"}} -->
<ul class="wp-block-social-links has-normal-icon-size has-icon-color is-style-logos-only"><!-- wp:social-link {"url":"#","service":"behance"} /-->
...
<!-- wp:group {"style":{"spacing":{"padding":{"top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}}},"backgroundColor":"dark","className":"our_works_home","layout":{"type":"default"},"metadata":{"name":"Our Works"}} -->
...
<!-- wp:group {"backgroundColor":"dark","className":"group_development","layout":{"type":"constrained"},"metadata":{"name":"Development"}} -->
<div class="wp-block-group group_development has-dark-background-color has-background"><!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|80","left":"var:preset|spacing|80"},"blockGap":"0"}},"layout":{"type":"flex","flexWrap":"nowrap","justifyContent":"center"}} -->
<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--80)"><!-- wp:paragraph {"align":"center","style":{"typography":{"lineHeight":"2"}},"className":"justify text_development","fontSize":"Large"} -->
<p class="has-text-align-center justify text_development has-large-font-size" style="line-height:2">At our creative agency, we're dedicated to transforming ideas into captivating experiences that resonate with audiences across the digital landscape. Our mission is to infuse innovation and imagination into every project, crafting stories that leave a lasting impact.</p>
<!-- /wp:paragraph --></div>
<!-- /wp:group --></div>
<!-- /wp:group -->

<!-- wp:group {"style":{"spacing":{"padding":{"right":"0","left":"0","top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}},"elements":{"link":{"color":{"text":"var:preset|color|fifth"}}}},"backgroundColor":"dark","textColor":"fifth","layout":{"type":"default"},"metadata":{"name":"Marquee"}} -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"right":"var:preset|spacing|80","left":"var:preset|spacing|80","top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}}},"gradient":"transition","className":"about_section","layout":{"type":"default"},"metadata":{"name":"About"}} -->
...
<figure class="wp-block-image size-full img_about"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/company.png" alt="" class="wp-image-285"/></figure>
<!-- /wp:image --></div>
<!-- /wp:column -->
...
<!-- wp:group {"style":{"spacing":{"padding":{"right":"0","left":"0","top":"var:preset|spacing|80","bottom":"var:preset|spacing|80"}}},"backgroundColor":"second","className":"team_section","layout":{"type":"default"},"metadata":{"name":"Our Team"}} -->
...
<div class="wp-block-group" style="padding-right:var(--wp--preset--spacing--80);padding-left:var(--wp--preset--spacing--80)"><!-- wp:media-text {"mediaId":73,"mediaLink":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/member-1","mediaType":"image","mediaSizeSlug":"full","verticalAlignment":"center","imageFill":false} -->
<div class="wp-block-media-text is-stacked-on-mobile is-vertically-aligned-center"><figure class="wp-block-media-text__media"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/member-1.jpg" alt="" class="wp-image-73 size-full"/></figure><div class="wp-block-media-text__content"><!-- wp:heading {"textAlign":"center"} -->
...
<!-- wp:media-text {"mediaId":73,"mediaLink":"<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/member-1","mediaType":"image","mediaSizeSlug":"full","imageFill":false} -->
<div class="wp-block-media-text is-stacked-on-mobile"><figure class="wp-block-media-text__media"><img src="<?php echo esc_url( get_stylesheet_directory_uri() ); ?>/assets/images/member-1.jpg" alt="" class="wp-image-73 size-full"/></figure><div class="wp-block-media-text__content"><!-- wp:heading {"textAlign":"center"} -->
